...
FlightStats.prototype = {
  ...
  lookup: function( options, callback ) {
     ...
     * NOTE 2018-10-02: it's safer to check +2 days window as some flights are
     * not returned although they're less than 3 days in the future. Caused 
     * Emirates Bug Lima-603
     */
    var timeMin = now - ( 8 * 24 ) * 60 * 60 * 1000
    var timeMax = now + ( 2 * 24 ) * 60 * 60 * 1000
